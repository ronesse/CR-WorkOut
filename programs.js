...
(() => {
  ...
  window.CR_PROGRAMS = {
    ...
    sequence: {
      ...
      tif_offseason_1_v1:{name:"TIF Viking – Økt 1 Underkropp variant 1",items:tifOffseasonRows("tif_offseason_1_v1")},
      tif_offseason_1_v2:{name:"TIF Viking – Økt 1 Underkropp variant 2",items:tifOffseasonRows("tif_offseason_1_v2")},
      tif_offseason_2_v1:{name:"TIF Viking – Økt 2 Overkropp variant 1",items:tifOffseasonRows("tif_offseason_2_v1")},
      tif_offseason_2_v2:{name:"TIF Viking – Økt 2 Overkropp variant 2",items:tifOffseasonRows("tif_offseason_2_v2")},
      tif_offseason_3_v1:{name:"TIF Viking – Økt 3 Split Over/underkropp variant 1",items:tifOffseasonRows("tif_offseason_3_v1")},
      tif_offseason_3_v2:{name:"TIF Viking – Økt 3 Split Over/underkropp variant 2",items:tifOffseasonRows("tif_offseason_3_v2")}
    }
  };
})();
